...
export function AutomationActionsMenu({ onEdit, onDuplicate, onDelete }: Props) {
      ...
      {open && (
        <div className="absolute right-0 z-10 mt-2 w-40 rounded-xl border border-slate-200 bg-white py-1 shadow-lg dark:border-slate-700 dark:bg-[#0f172a]">
          ...
          <button
            ...
            className="flex w-full items-center gap-2 px-3 py-2 text-left text-sm text-red-500 hover:bg-red-50 dark:hover:bg-red-500/10"
          >
